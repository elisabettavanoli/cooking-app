...
const en: Dict = {
  ...
  "profile.iconStyleHint": "How ingredients look across the app.",
...
const it: Dict = {
  ...
  "profile.iconStyle": "Stile delle icone",
  "profile.iconStyleHint": "Come appaiono gli ingredienti in tutta l'app.",
  "profile.iconStyleEmoji": "Emoji",
  "profile.iconStyleOpenmoji": "OpenMoji",
  "profile.iconStyleFoodiconpack": "Outline",
